    ...
    public partial class profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnSave.Click += (se, ev) =>
            {
                ...
                int g = obj.InsertTweet((int)Session["userid"], Textbox5.Text, ref d);
            ...
            int found=0;
            found =obj.GetTweets(userid, ref DT);
            if(found==-1)
            {
        ...
        {
            Session["aboutid"] = (int)Session["userid"];
            ScriptManager.RegisterStartupScript(Page, typeof(System.Web.UI.Page), "click", @"<script>window.open('AboutUser.aspx?val=" + (int)Session["userid"] + "','_newtab');</script>", false);
        }
    }
}